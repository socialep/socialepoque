...
class Calcugay extends Component {
  ...
  onEqual = () => {
    ...
    const lastOperatorInFormula = finalFormula[finalFormula.length - 2];

    if (
      (lastOperatorInFormula === 'acos' || lastOperatorInFormula === 'asin') &&
  ...
  render() {
    ...
    const containerStyle = {
      backgroundImage: "url('./app/assets/lgbtcase.png')",
    ...
    return html`
      ...
      <div class="calcugay-container-main" style=${containerStyle}>
